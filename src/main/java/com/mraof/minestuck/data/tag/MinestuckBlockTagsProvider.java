...
public final class MinestuckBlockTagsProvider extends BlockTagsProvider
{
	...
	protected void addTags(HolderLookup.Provider provider)
	{
		...
		needsWoodPickaxe(RIND.get());
		needsWoodPickaxe(RIND_STAIRS.get());
		needsWoodPickaxe(RIND_SLAB.get());
		needsWoodPickaxe(RIND_WALL.get());
		needsWoodPickaxe(RIND_BRICKS.get());
		needsWoodPickaxe(RIND_BRICK_WALL.get());
		needsWoodPickaxe(RIND_BRICK_STAIRS.get());
		needsWoodPickaxe(RIND_BRICK_SLAB.get());
		needsWoodPickaxe(CHISELED_RIND_BRICKS.get());
		needsWoodPickaxe(CHISELED_RIND_BRICK_WALL.get());
		needsWoodPickaxe(CHISELED_RIND_BRICK_STAIRS.get());
		needsWoodPickaxe(CHISELED_RIND_BRICK_SLAB.get());
		needsWoodPickaxe(CRACKED_RIND_BRICKS.get());
		needsWoodPickaxe(CRACKED_RIND_BRICK_WALL.get());
		needsWoodPickaxe(CRACKED_RIND_BRICK_STAIRS.get());
		needsWoodPickaxe(CRACKED_RIND_BRICK_SLAB.get());
		needsWoodPickaxe(CHEESY_RIND_BRICKS.get());
		needsWoodPickaxe(CHEESY_RIND_BRICK_WALL.get());
		needsWoodPickaxe(CHEESY_RIND_BRICK_STAIRS.get());
		needsWoodPickaxe(CHEESY_RIND_BRICK_SLAB.get());
		needsWoodPickaxe(RIND_PILLAR.get());
		...
		wall(RIND_WALL.get());
		wall(RIND_BRICK_WALL.get());
		wall(CHISELED_RIND_BRICK_WALL.get());
		wall(CRACKED_RIND_BRICK_WALL.get());
		wall(CHEESY_RIND_BRICK_WALL.get());
		...
		tag(CRUXITE_ORES).add(STONE_CRUXITE_ORE.get(), NETHERRACK_CRUXITE_ORE.get(), COBBLESTONE_CRUXITE_ORE.get(), SANDSTONE_CRUXITE_ORE.get(), RED_SANDSTONE_CRUXITE_ORE.get(), END_STONE_CRUXITE_ORE.get(), PINK_STONE_CRUXITE_ORE.get(), SHADE_STONE_CRUXITE_ORE.get(), CHHURPI_URANIUM_ORE.get());
		tag(URANIUM_ORES).add(STONE_URANIUM_ORE.get(), DEEPSLATE_URANIUM_ORE.get(), NETHERRACK_URANIUM_ORE.get(), COBBLESTONE_URANIUM_ORE.get(), SANDSTONE_URANIUM_ORE.get(), RED_SANDSTONE_URANIUM_ORE.get(), END_STONE_URANIUM_ORE.get(), PINK_STONE_URANIUM_ORE.get(), SHADE_STONE_URANIUM_ORE.get(), CHHURPI_URANIUM_ORE.get());
		...
		tag(CHEESE_PLANT_DIRT).add(SWISS_CHEESE.get()).add(SMOOTH_SWISS_CHEESE.get()).add(AMERICAN_CHEESE.get()).add(SMOOTH_AMERICAN_CHEESE.get()).add(RIND.get());
		tag(CHEESE_LANDS_SURFACE).add(SMOOTH_SWISS_CHEESE.get()).add(RIND.get());
