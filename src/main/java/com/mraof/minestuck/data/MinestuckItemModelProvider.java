...
public class MinestuckItemModelProvider extends ItemModelProvider
{
	...
	protected void registerModels()
	{
		...
		wallItem(MSBlocks.RIND_WALL, MSBlocks.RIND);
		wallItem(MSBlocks.RIND_BRICK_WALL, MSBlocks.RIND_BRICKS);
		wallItem(MSBlocks.CHISELED_RIND_BRICK_WALL, MSBlocks.CHISELED_RIND_BRICKS);
		wallItem(MSBlocks.CRACKED_RIND_BRICK_WALL, MSBlocks.CRACKED_RIND_BRICKS);
		wallItem(MSBlocks.CHEESY_RIND_BRICK_WALL, MSBlocks.CHEESY_RIND_BRICKS);
